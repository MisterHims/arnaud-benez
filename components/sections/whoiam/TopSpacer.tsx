...
export const TopSpacer = () => {
  return (
    <div className="relative w-full h-full min-h-screen bg-[#f8f8f8] flex flex-col justify-end">
      {/* 
        Le conteneur prend tout l'écran avec un fond blanc.
        Le SVG est collé en bas.
      */}
      <div className="w-full relative z-10 leading-0">
        <svg
          className="w-full h-auto min-h-[200px] md:min-h-[300px] block"
          viewBox="0 0 1800 600"
          preserveAspectRatio="none"
          xmlns="http://www.w3.org/2000/svg"
        >
          {/* Fond blanc du SVG pour lisser la jonction si besoin, mais le bg-parent suffit */}
