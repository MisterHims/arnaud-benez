...
import { TopSpacer } from './whoiam/TopSpacer';

export const WhoIAm = () => {
  return (
    <div className="w-full">
      {/* PART 1: Spacer Transition (Full Screen) */}
      <SectionShell variant="full" className="h-screen min-h-screen relative p-0 overflow-hidden">
        <TopSpacer />
      </SectionShell>

      {/* PART 2: Real Content (Full Screen below) */}
      <SectionShell variant="contained" className="min-h-screen grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-14 relative overflow-hidden flex items-center">
