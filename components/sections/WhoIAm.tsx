...
export const WhoIAm = () => {
  return (
    <SectionShell variant="contained" className="min-h-screen grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-14 relative overflow-hidden flex items-center bg-[#0c0c0c] z-10">
