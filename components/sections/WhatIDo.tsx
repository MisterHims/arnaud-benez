...
export const WhatIDo = () => {
  return (
    <section className='h-full w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 pt-24 pb-12 px-6 items-center'>

      {/* ZONE GAUCHE : Scroll Interne */}
      <div
        className='md:col-span-5 h-[60vh] md:h-[70vh] overflow-y-auto pr-4 space-y-6 swiper-no-swiping scrollbar-hide'
        onWheel={(e) => e.stopPropagation()} // Bloque le Swiper ici
      >
        {/* Carte 1 */}
      ...
      {/* ZONE DROITE */}
      <div className='md:col-span-7 h-full flex flex-col justify-center text-left'>
